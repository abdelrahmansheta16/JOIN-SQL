...
ALTER TABLE processing_order ADD FOREIGN KEY (customer_id) REFERENCES customer(customer_id);
ALTER TABLE order_item ADD FOREIGN KEY (order_id) REFERENCES processing_order(order_id);
...
ALTER TABLE shipment ADD FOREIGN KEY (order_id) REFERENCES processing_order(order_id);
